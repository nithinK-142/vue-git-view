<template>
  <div v-if="isUserLoading" class="flex flex-col items-center w-full p-2 mb-4">
    <!-- avatar -->
    <div class="w-32 h-32 bg-gray-300 rounded-full sm:w-48 sm:h-48 animate-pulse"></div>

    <div class="flex flex-col justify-start mt-4">
      <!-- name -->
      <div class="w-48 h-6 mx-auto mt-4 bg-gray-300 rounded animate-pulse"></div>
      <!-- login -->
      <div class="w-32 h-4 mx-auto mt-2 bg-gray-300 rounded animate-pulse"></div>

      <!-- bio -->
      <div class="w-11/12 h-4 mx-auto mt-4 bg-gray-300 rounded animate-pulse"></div>
      ...
      <div class="flex items-center my-2 mb-2 space-x-1">
        ...
        >
          ...
          <span class="h-4 text-xs tracking-wider text-gray-700 dark:text-gray-200"></span>
        </div>
        <div
          class="flex flex-col items-center justify-between px-6 py-4 font-semibold bg-gray-300 rounded-md w-28 animate-pulse"
        >
  ...
  >
    ...
    <div class="flex flex-col justify-start mt-4">
      ...
      <p v-if="user.bio" class="mt-2 text-center text-gray-700 dark:text-gray-200">
      ...
      <div class="flex flex-col justify-center mt-2 mb-4 text-base tracking-wide">
        <div v-if="user.company" class="flex items-center mt-1 text-gray-700 dark:text-gray-200">
          <div class="h-4 mr-1 fill-black dark:fill-white">
            <svg viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg" class="w-auto h-full">
              <path
        ...
        <div v-if="user.location" class="flex items-center mt-1 text-gray-700 dark:text-gray-200">
          <div class="h-4 mr-1 fill-black dark:fill-white">
            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="w-auto h-full">
              <path
