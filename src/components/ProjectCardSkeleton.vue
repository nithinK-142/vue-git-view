  ...
  >
    <div>
      <div class="relative flex justify-between mb-2">
        <h5 class="w-1/2 h-5 rounded animate-pulse bg-neutral-300/90 dark:bg-neutral-400/80"></h5>
        <div
          class="absolute top-0 right-0 w-10 h-4 rounded-full animate-pulse bg-neutral-300/90 dark:bg-neutral-400/80"
        ></div>
      </div>
      <p class="mb-1 animate-pulse h-[14px] rounded bg-neutral-300/90 dark:bg-neutral-400/80"></p>
      <p class="mb-3 animate-pulse h-[14px] rounded bg-neutral-300/90 dark:bg-neutral-400/80"></p>
    </div>
